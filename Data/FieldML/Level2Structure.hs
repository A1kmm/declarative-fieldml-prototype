...
type Identifier = LBS.ByteString
...
data L2Model =
  L2Model
  {
    ...
    l2AllBaseUnits :: M.Map L2UnitBaseID L2BaseUnitContents,
    l2NextBaseUnits :: L2BaseUnitsID,
    l2AllClassess :: M.Map L2ClassID L2ClassContents,
    l2NextClassID :: L2ClassID,
    l2AllInstances :: [L2Instance],
...
data L2NamespaceContents =
  ...
  {
    l2nsSrcSpan :: SrcSpan,
    l2nsNamespaces :: M.Map Identifier L2NamespaceContents,
...
data L2DomainContents =
  ...
  L2BuiltinDomainContents {
    l2DomainSS :: SrcSpan,
    l2BuiltinDomainIdentifier :: LBS.ByteString
    }
  deriving (Eq, Ord, Show, Data, Typeable)
...
data L2Expression = L2ExApply { l2ExSS :: SrcSpan, l2ExOp :: L2Expression, l2ExArg :: L2Expression } |
                    ...
                    L2ExReferenceValue { l2ExSS :: SrcSpan, l2ExValue :: L2ValueID } |
                    L2ExReferenceClassValue { l2ExSS :: SrcSpan, l2ExValue :: L2ClassValueID } |
                    ...
                    L2ExString { l2ExSS :: SrcSpan, l2ExStringValue :: LBS.ByteString } |
...
data L2DomainExpression = L2DomainExpressionProduct { l2DomainExpressionSS :: SrcSpan,
                                                      l2DomainExpressionLabels :: L2DomainExpressionLabels :: L2LabelledDomains } |
...
data L2DomainFunctionContents = L2DomainFunctionContents SrcSpan L2DomainType
data L2ClassValueContents = L2ClassValueContents SrcSpan L2DomainType
data L2Label = L2Label { l2LabelEnsemble :: L2NamespaceID, l2LabelValue :: Integer }
